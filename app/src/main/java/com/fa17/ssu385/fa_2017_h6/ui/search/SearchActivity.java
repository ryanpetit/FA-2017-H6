...
public class SearchActivity extends AppCompatActivity implements SearchView {
    ...
    @Override
    public void displayResult(Recipe recipe) { // display name and thumbnail
        recipeName.setText(recipe.getName());
        Glide.with(SearchActivity.this).load(recipe.getThumbnailSources().get(0)).into(recipeThumbnail);
    }
